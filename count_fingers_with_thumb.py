...
def countFingers(image, hand_landmarks, handNo=0):
    if hand_landmarks:
        # Obtenha todos os pontos de referência da PRIMEIRA mâo VÍSIVEL
        ...
        for lm_index in tipIds:
                ...
                thumb_tip_y = landmarks[lm_index].x
                thumb_bottom_y = landmarks[lm_index - 2].x
...
def drawHandLandmarks(image, hand_landmarks):
    #Desenhar as conexões entre os pontos de referência das mãos
    if hand_landmarks:
